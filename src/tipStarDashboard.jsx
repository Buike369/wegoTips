...
import Demo from "./tipSterDashHome"
        ...
        <div className="dashboardItem">
            <div className="menuDiv">
                ...
                <ul className="dashList">
                    ...
                    <li  className={backColor ==="tips1"?"param":""}>
                    ...
                    <li  className={backColor ==="tips2"?"param":""}>
                    ...
                    <li  className={backColor ==="tips3"?"param":""}> <div className="Homdash"><FontAwesomeIcon icon={faTrash} className="iconDash" /> <span className="dashboardIcon"> Delete Post</span></div></li>
                    <li className={backColor ==="tips4"?"param":""}><div className="Homdash"><FontAwesomeIcon icon={faUsers} className="iconDash" /> <span className="dashboardIcon"> Users</span></div></li>
                    <li  className={backColor ==="tips5"?"param":""}><div className="Homdash"><FontAwesomeIcon icon={faMoneyBill1Wave} className="iconDash" /> <span className="dashboardIcon">Funding</span></div></li>
