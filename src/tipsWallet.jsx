...
<div style={{padding:"0 5px"}}>
    <div className="WallForm">
       {error && <p style={{position:"absolute",top:"18%",left:"50%",color:"#fff",textAlign:"center",background:"red",padding:"10px 5px"}}>{error}</p>}
            <div className="Wallet_P_Div Wallet_Up_Div">
                <div className="Pmain">
                <div className="P_P">
                    <div className={wallet === "wallets" ?"overView gbg" : "overView" } onClick={setGo2}>Affiliate Overview </div>
                    <div className={refferal === "fort" ?"overView gbg" : "overView" } onClick={setGo1}>Transactions/Referrals Subscription</div>
                </div>
                </div>
   ...
   <div>
    ...
    <div className ="newPSubcribe">
      <p className ="newPSubcribe1">Unlock Your Affiliate wallet and get access to tons of opportunity to make money  </p>
      <div className ="newPSubcribe2">Click To Unlock Now</div>
    </div>

           { wallet === "wallets"? 
             <div>
                 <div className="Att"> <div className="AllTrans">
                 ...
                 <div>
                     <ul className="TYPE_DATE">
                         ...
                         <li className="STaTus">Users ID</li>
